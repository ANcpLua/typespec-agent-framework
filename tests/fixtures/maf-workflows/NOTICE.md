...
for PR-3: `tools/workflow-equiv.mjs` parses each and deep-compares it (modulo key order /
formatting) against the YAML this repo's `maf-workflow-yaml` emitter produces from
