...
Dialect D2's workflow emitter (which consumes these models), D3 hosted manifests,
and telemetry-at-birth land in later PRs. The complete maximum-scope plan, the
